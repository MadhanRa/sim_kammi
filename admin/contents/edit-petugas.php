...
if (isset($_GET['id_petugas'])) {
    ...
    $tampil = $koneksi->query("SELECT id_petugas, nama_petugas, no_hp, alamat FROM data_petugas WHERE id_petugas=$id_petugas");
            ...
            <div id="collapse2" class="body collapse in">
                <form class="form-horizontal" action="library/update_petugas.php" method="POST" id="popup-validation">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="nama" class="form-control chzn-select" tabindex="2" value="<?= $tampil['nama_petugas'] ?>" />
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-lg-4">
                            <input type="text" name="no_hp" class="form-control chzn-select" tabindex="2" value="<?= $tampil['no_hp'] ?>" />
                        </div>
                    </div>
