...
if (isset($_POST['cetak'])) {
	$db = dbConnect();
	$data = array();
	$sql = mysqli_query($db, "SELECT id_user,nama_user,nohp_user,alamat_user FROM tbl_user");
	...
	$header = array(
		...
		array("label" => "Nama User", "length" => 50, "align" => "L"),
		array("label" => "No HP", "length" => 41, "align" => "L"),
		array("label" => "Alamat", "length" => 87, "align" => "L")
	);
